...
const GEO_LOOKUP: { match: string[]; point: GeoPoint }[] = [
  ...
  { match: ["maldives", "maladewa"], point: { name: "Maldives", lng: 73.2, lat: 3.2 } },
  { match: ["sri lanka", "srilanka"], point: { name: "Sri Lanka", lng: 80.7, lat: 7.9 } },
  { match: ["south africa", "afrika selatan"], point: { name: "South Africa", lng: 24, lat: -29 } },
  { match: ["phillipina", "philippine", "filipina", "philipina"], point: { name: "Philippines", lng: 122, lat: 12.9 } },
  { match: ["mozambique", "mozambik"], point: { name: "Mozambique", lng: 35.5, lat: -18.7 } },
  ...
  { match: ["stockton", "usa", "united states", "amerika"], point: { name: "USA", lng: -121.3, lat: 38 } },
  { match: ["reunion"], point: { name: "Reunion Island", lng: 55.5, lat: -21.1 } },
];
